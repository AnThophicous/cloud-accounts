...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "relative w-full overflow-hidden border border-[var(--app-line)] bg-[var(--app-surface)]",
        className,
      )}
    >
      <div className="flex items-center justify-between border-b border-[var(--app-line)] px-4 py-3">
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full bg-[var(--app-line-strong)]" />
          <span className="h-2 w-2 rounded-full bg-[var(--app-line-strong)]" />
          <span className="h-2 w-2 rounded-full bg-[var(--app-line-strong)]" />
        </div>
        <span className="text-[11px] uppercase tracking-[0.24em] text-[var(--app-fg-soft)]">Terminal</span>
      </div>
      <pre className="p-4 text-sm leading-7 text-[var(--app-fg)]">

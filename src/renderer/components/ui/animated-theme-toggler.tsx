...
import { BoxMoon, BoxSun } from "./boxicon";

export type ThemeVariant = "circle" | "square" | "triangle" | "diamond" | "hexagon" | "rectangle" | "star";
...
export const AnimatedThemeToggler = ({
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsDark(document.documentElement.getAttribute("data-theme") === "dark" || document.documentElement.classList.contains("dark"));
    };
  ...
  return (
    <button type="button" ref={buttonRef} onClick={toggleTheme} className={cn(className)} {...props}>
      {isDark ? <BoxSun className="h-5 w-5" /> : <BoxMoon className="h-5 w-5" />}
